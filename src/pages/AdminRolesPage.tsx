...
export function AdminRolesPage() {
  ...
  return <div className="min-h-screen p-4 space-y-4">
    <div className="flex items-center gap-3"><Link to="/admin"><button className="w-9 h-9 rounded-xl bg-ink-800 flex items-center justify-center text-slate-300"><ArrowLeft size={18} /></button></Link><div><h1 className="font-display font-bold text-xl text-fg">Manajemen Role</h1><p className="text-xs text-slate-500">Hanya admin backend yang dapat mengubah role pengguna.</p></div><Badge color="moss">Admin</Badge></div>
