  ...
  return <div className="min-h-screen surface-bg text-fg-secondary p-5 md:p-8">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div><p className="text-xs text-moss-400">BANK SOAL LIVE</p><h1 className="text-2xl font-bold text-fg">{loading ? 'Memuat…' : bank?.name || 'Bank Soal'}</h1><p className="text-sm text-slate-500 mt-1">Kelola pertanyaan dan kunci jawaban langsung di Supabase.</p></div>
