...
export function CollectiveParticipantLoginPage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      sessionStorage.setItem('syka_collective_access_token', String(result.access_token || ''));
