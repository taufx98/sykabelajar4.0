...
import { LayoutDashboard, Trophy, Users, FileText, ShoppingBag, Store, Building2, MessageCircle, Coins, Settings, ShieldCheck, ClipboardList, Megaphone, Award, Wrench, CreditCard, AtSign } from 'lucide-react';
import { Card } from '@/components/ui/Card';
import { Badge } from '@/components/ui/Badge';
import { AdminDashboard } from '@/components/admin/AdminDashboard';
import { AdminUsernameShortcut } from '@/components/admin/AdminUsernameShortcut';
...
const MODULES: AdminModule[] = [
  ...
  { title: 'Pengguna', description: 'Moderasi akun, role, profil, dan status pengguna.', path: '/admin/core?tab=users', icon: Users },
  ...
  { title: 'Ganti Username', description: 'Ubah username akun sendiri atau pengguna lain dengan audit backend.', path: '/admin?section=username', icon: AtSign, badge: 'Admin' },
];
...
export function AdminControlCenterPage() {
  ...
  const showUsername = searchParams.get('section') === 'username';
