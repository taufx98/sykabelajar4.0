...
function ChatLockModal({
  ...
  return (
    <div
      className="fixed inset-x-0 top-0 bottom-16 z-30 flex items-center justify-center p-4 md:inset-y-0 md:bottom-0 md:left-[max(250px,calc((100vw-1440px)/2+250px))] xl:left-[max(270px,calc((100vw-1440px)/2+270px))]"
      role="dialog"
      aria-modal="true"
