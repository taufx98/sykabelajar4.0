...
export function AdminCommunicationLinks() {
  ...
  return (
    <div className="flex flex-wrap gap-2 rounded-2xl border surface-border surface-card-bg p-2">
      ...
      <span className="inline-flex items-center gap-2 rounded-xl px-3 py-2 text-xs text-fg-muted">
        <Users size={15} /> Admin dapat memakai Chat Pribadi dan Chat Grup seperti akun biasa.
      </span>
    </div>
  );
}
